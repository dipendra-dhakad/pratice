    ...
    if(clickedTab !== currentTab){
        ...
        if (!searchForm.classList.contains("active")) {
            ...
            searchForm.classList.add("active");
              ...
              //main pehle search wale tab pr tha, ab your  weather tab visible krna he
            searchForm.classList.remove("active");
            userInfoContainer.classList.remove("remove");
            //ab main your weather tab me agya hu , toh weather bhi display karna padega , so let's check storage first
